...
%	For our purposes, that is enough to prove Proposition~\ref{prop:PW-L-cont}
%	for some $1\mathbin{\le}p\mathbin{<}\infty$.
\end{remark}
...
%Only the upper bound of $\ME(X_t - X_s)^2$ are constructed.
\end{proof}
...
= \int_0^v dW_s = W_v.
\]
%Thus, the inverse representation is
%\begin{align*}
%W_v &= \int_0^v L(v,t)\, dX_t
%\\ &=
